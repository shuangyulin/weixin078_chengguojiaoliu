<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="科目" prop="kemu">
        ...
        <div v-else>
          <el-form-item class="input" label="科目" prop="kemu">
	      <el-input v-model="ruleForm.kemu"
                placeholder="科目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="课程视频" prop="kechengshipin">
          <file-upload
          tip="点击上传课程视频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.kechengshipin" label="课程视频" prop="kechengshipin">
            <el-button type="text" size="small" @click="download(ruleForm.kechengshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengjianjie" label="课程简介" prop="kechengjianjie">
                    <span>{{ruleForm.kechengjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../ssmw52wu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
