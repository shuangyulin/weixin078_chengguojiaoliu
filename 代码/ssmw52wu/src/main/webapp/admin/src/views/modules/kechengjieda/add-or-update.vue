<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科目" prop="kemu">
          <el-input v-model="ruleForm.kemu" 
              placeholder="科目" clearable  :readonly="ro.kemu"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="解答内容" prop="jiedaneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="解答内容"
                  v-model="ruleForm.jiedaneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiedaneirong" label="解答内容" prop="jiedaneirong">
                    <span>{{ruleForm.jiedaneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kemu = true;
          ...
          if(o=='jiedaneirong'){
            this.ruleForm.jiedaneirong = obj[o];
	    this.ro.jiedaneirong = true;
            continue;
          }
          if(o=='jiedariqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kechengjieda/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kechengjiedaCrossAddOrUpdateFlag = false;
                  this.parent.search();
