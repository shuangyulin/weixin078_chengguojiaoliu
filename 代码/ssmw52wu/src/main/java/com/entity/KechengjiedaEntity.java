...
public class KechengjiedaEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public KechengjiedaEntity() {
		
	}
	
	public KechengjiedaEntity(T t) {
		try {
	 ...
	 * 设置：解答内容
	 */
	public void setJiedaneirong(String jiedaneirong) {
		this.jiedaneirong = jiedaneirong;
	}
	/**
	 * 获取：解答内容
	 */
	public String getJiedaneirong() {
		return jiedaneirong;
	}
	/**
	 * 设置：解答日期
